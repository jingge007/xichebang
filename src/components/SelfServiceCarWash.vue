      ...
      <div class="info-card green-bg">
        ...
        <div class="tips-content">
          ...
          <ul>
            ...
            <li>充值面额会随市场行情调整，以手机充值界面显示为准</li>
          </ul>

          <p class="section-title"><strong>赠送金规则：</strong></p>
          <ul>
            <li>赠送金有效期为两年（自赠送之日起计算）</li>
            <li>充值100、150元赠送金有效期为一年，200元以上赠送金有效期为两年</li>
          ...
          <ul>
            <li>目前仅广西靖西市(民族综合市场)一个洗车站点</li>
            <li>注册成功后需先充值金额才能扫码启动机器洗车</li>
            <li>如有问题请在微信喜车邦公众号中咨询在线客服！</li>
          </ul>
        </div>
      </div>
      <!--自助洗车使用流程-->
